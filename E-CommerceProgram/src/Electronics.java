...
public class Electronics extends Order implements Transferable {
	private int qty;
	private int weight;
	private int insuranceCost;
	private int packCost;

	public Electronics(String name, String category, String ID, int price, int shipCost, int qty, int weight,
